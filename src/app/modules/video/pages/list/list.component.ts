...
import { VideoPagination } from "@app/services/videos/videos.type";
...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    this._videoService.videoPagination$
  ...
  ngAfterViewInit(): void {
    merge(this._matSort.sortChange, this._matPaginator.page, this.searchInput.valueChanges)
      .pipe(
        ...
        switchMap(() => {
          this.isLoading = true;
          return this._videoService.getVideos(
