...
import { ArtistPagination } from "@services/artists/artists.type";
...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    this._artistService.artistPagination$
      .pipe(takeUntil(this.unsubscribe$))
      .subscribe((value): void => {
        this.isLoading = false;
        this.artistPagination = value;
  ...
  ngAfterViewInit(): void {
    merge(this._matSort.sortChange, this._matPaginator.page, this.searchInput.valueChanges)
      .pipe(
        ...
        switchMap(() => {
          this.isLoading = true;
          return this._artistService.getArtist(
  ...
  deleteArtist(id: string) {
    this._artistService.deleteArtist(id).subscribe({
      next: () => {
        this._artistService.getArtist().subscribe();
