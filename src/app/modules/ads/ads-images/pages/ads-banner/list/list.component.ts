...
import { AdsImagePagination } from "@services/adsimages/ads-images.type";
...
@Component({
  selector: "app-list-ads-image-ads-banner",
  standalone: true,
  imports: [
    AlertComponent,
    ChipStatusComponent,
...
export class AdsBannerListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  adsBannerPagination?: AdsImagePagination;
  adsBannerLength?: number;
  accountAdsImagePermission?: Permission;
  router?: Router;
  urlImage = environment.apiUrl + "/images/";
  adsImageColumns: string[] = [
    "no",
    "adsName",
    "view",
    "click",
  ...
  constructor(
    private _adsImagesService: AdsImagesService,
  ...
  ngOnInit(): void {
    ...
    this._adsImagesService.adsImage$
      .pipe(takeUntil(this.unsubscribe$))
      .subscribe((value: AdsImagePagination): void => {
        this.isLoading = false;
        this.adsBannerPagination = value;
        this.adsBannerLength = value.adsImages.length;
  ...
  ngAfterViewInit(): void {
    merge(this._matSort.sortChange, this._matPaginator.page, this.searchInput.valueChanges)
      .pipe(
        ...
        switchMap(() => {
          this.isLoading = true;
          return this._adsImagesService.getListHomeBanner(
            this.pageParam,
            this.positionParam,
  ...
  onRoute() {
    return this._router.navigateByUrl(
      `/ads/ads-image/menu/${this.pageParam}/${this.positionParam}/create`
    );
  }
