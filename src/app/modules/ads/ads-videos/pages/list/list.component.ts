...
import { AdsVideoPagination } from "@services/adsvideos/ads-videos.type";
...
export class AdsVideoListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  adsVideoPagination?: AdsVideoPagination;
  adsVideoLength?: number;
  accountAdsVideoPermission?: Permission;
  router?: Router;
  adsVideoColumns: string[] = [
    "no",
    "adsName",
    "totalView",
    "totalClick",
  ...
  constructor(
    private _adsVideosService: AdsVideoService,
  ...
  ngOnInit(): void {
    this._adsVideosService.adsVideo$
      .pipe(takeUntil(this.unsubscribe$))
      .subscribe((value: AdsVideoPagination): void => {
        this.isLoading = false;
        this.adsVideoPagination = value;
        this.adsVideoLength = value.adsVideos.length;
  ...
  ngAfterViewInit(): void {
    merge(this._matSort.sortChange, this._matPaginator.page, this.searchInput.valueChanges)
      .pipe(
        ...
        switchMap(() => {
          this.isLoading = true;
          return this._adsVideosService.getList(
